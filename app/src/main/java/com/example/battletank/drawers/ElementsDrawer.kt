...
import com.example.battletank.R
...
import com.example.battletank.models.Element

class ElementsDrawer(val container:FrameLayout) {
    var currentMaterial=Material.EMPTY
private val elementContainer= mutableListOf<Element>()
    ...
    fun onTouchContainer(x:Float,y:Float){
     ...
     fun drawView(coordinate: Coordinate){
        ...
        elementContainer.add(Element(viewId,currentMaterial,coordinate))
    }
    ...
    private fun getElementByCoordinates(coordinate: Coordinate)=
        elementContainer.firstOrNull { it.coordinate==coordinate }
